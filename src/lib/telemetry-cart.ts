...
//     handlers. telemetry.ts subscribes to this mirror and re-tracks Supabase
//     Realtime presence with cart_value_cents / has_cart on every change — the
//     signal that drives the amber high-value border on /admin/command/live.
//
