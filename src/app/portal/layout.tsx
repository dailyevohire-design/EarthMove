  ...
  return (
    <div className="min-h-screen flex bg-stone-950">
      ...
      <aside className="w-56 flex-shrink-0 border-r border-stone-800 flex flex-col bg-stone-900/50 sticky top-0 h-screen">
        <div className="h-16 flex items-center px-5 border-b border-stone-800">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="text-[10px] text-stone-500">Supplier Portal</div>
            </div>
          </div>
        </div>
        ...
        <div className="px-2.5 py-4 border-t border-stone-800">
...
function PortalLink({ href, icon, label }: { href: string; icon: React.ReactNode; label: string }) {
  return (
    <Link
      href={href}
      className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium text-stone-400 hover:bg-stone-800 hover:text-stone-200 transition-all"
    >
