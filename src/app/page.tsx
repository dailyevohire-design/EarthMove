      ...
      <main>
        <section className="bg-gray-900 py-16 md:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-gray-400 text-lg mt-5 max-w-lg">
              Serving {markets?.length ?? 0} markets. Fill dirt, gravel, sand, topsoil, road base — delivered same-day.
            </p>
        ...
        <section className="py-16 bg-emerald-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link href="/browse" className="btn bg-white text-emerald-700 btn-xl font-bold shadow-xl inline-flex">
