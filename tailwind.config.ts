    ...
    extend: {
      ...
      colors: {
        ...
        commerce: {
          ...
          'ops-bg': 'var(--commerce-ops-bg)',
          'ops-bg-2': 'var(--commerce-ops-bg-2)',
          'ops-line': 'var(--commerce-ops-line)',
          'ops-line-2': 'var(--commerce-ops-line-2)',
          'ops-ink': 'var(--commerce-ops-ink)',
          'ops-ink-2': 'var(--commerce-ops-ink-2)',
          'ops-ink-3': 'var(--commerce-ops-ink-3)',
          'ops-accent': 'var(--commerce-ops-accent)',
          'ops-active': 'var(--commerce-ops-active)',
          'ops-warn': 'var(--commerce-ops-warn)',
          'm-base': 'var(--commerce-m-base)',
          'm-drain': 'var(--commerce-m-drain)',
          'm-fill': 'var(--commerce-m-fill)',
          'm-soil': 'var(--commerce-m-soil)',
          'm-struct': 'var(--commerce-m-struct)',
        },
      },
      borderRadius: {
